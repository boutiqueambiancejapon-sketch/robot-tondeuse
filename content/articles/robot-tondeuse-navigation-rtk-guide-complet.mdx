...
Un point sur les modèles Husqvarna NERA : ils utilisent la technologie EPOS, un système de navigation satellitaire propriétaire qui n'est pas du RTK au sens strict, mais qui offre une précision comparable. La différence notable : l'écosystème Husqvarna est fermé et un abonnement cloud est requis passé la période d'essai. Pour plus de détails sur cette marque, notre comparatif [Husqvarna Automower vs Mammotion Luba](/husqvarna-automower-vs-mammotion-luba) met les deux approches face à face.
